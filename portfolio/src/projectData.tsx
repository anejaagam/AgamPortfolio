import { Project, Technology, Experience, Course } from "./data";
...
export const projects: Project[] = [
    ...
    pdfLink: require("./MechanicalProjects/169/APSC169FinalLab.pdf"),
    githubLink: "path/to/github/repo",
    images: [require("./MechanicalProjects/169/ProjectPic1.jpg"), require("./MechanicalProjects/169/ProjectPic2.jpg")],
    ...
    },
    {
            ...
            image: "path/to/image.jpg",
            pdfLink: require("./MechanicalProjects/305/305KeeyaskHydroelectricProjectReport.pdf"),
            githubLink: "path/to/github/repo",
            images: [],
    ...
    image: "path/to/image.jpg",
    pdfLink: require("./MechanicalProjects/376/HeatTreatmentProject.pdf"),
    githubLink: "path/to/github/repo",
    images: [],
    ...
    image: require("./MechanicalProjects/377/377 Report.pdf"),
    pdfLink: "path/to/report.pdf",
    githubLink: "path/to/github/repo",
    images: [require("./MechanicalProjects/377/initial drawings pt1.png"), require("./MechanicalProjects/377/initial drawings pt2.png"), require("./MechanicalProjects/377/Design.jpg"), require("./MechanicalProjects/377/377 Flow Chart.jpg")],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/406/ENGR 406 - Final Project Report.pdf"),
        githubLink: "path/to/github/repo",
        images: [require("./MechanicalProjects/406/406_1.jpg"), require("./MechanicalProjects/406/406_2.jpg"), require("./MechanicalProjects/406/406_3.jpg")],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/460/MOORA_Report_Final_Revised.pdf"),
        githubLink: "path/to/github/repo",
        images: [],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/460/Project Report.pdf"),
        githubLink: "path/to/github/repo",
        images: [],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/480/Poster.pdf"),
        githubLink: "path/to/github/repo",
        images: [require("./MechanicalProjects/480/Poster1.jpg"),require("./MechanicalProjects/480/Poster2.jpg")],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/486/MANF 486 Lab 2 - Measuring Station.pdf"),
        githubLink: "path/to/github/repo",
        images: [],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/486/Manf486_Lab3_Report.pdf"),
        githubLink: "path/to/github/repo",
        images: [],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/486/MANF 486 Lab 6 - Electro-Pneumatic Circuits.pdf"),
        githubLink: "path/to/github/repo",
        images: [],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/486/Manf 486 Lab 8.pdf"),
        githubLink: "path/to/github/repo",
        images: [],
    ...
    {
        id: 14,
        title: " Capstone - Open Source Recumbent E-Trike: Enhancing Sustainable Transportation in Kelowna",
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/499/ENGR 499_ Final Design Report.pdf"),
        githubLink: "path/to/github/repo",
        images: [require("./MechanicalProjects/499/cad.jpg"), require("./MechanicalProjects/499/PictureFrame.jpg"), require("./MechanicalProjects/499/circuit.jpg"), require("./MechanicalProjects/499/app.jpg"), require("./MechanicalProjects/499/final.jpg"), require("./MechanicalProjects/499/RecumbentFrame_Page_1.jpg"), require("./MechanicalProjects/499/RecumbentFrame_Page_2.jpg"), require("./MechanicalProjects/499/RecumbentFrame_Page_3.jpg")],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/Gearbox/Report.pdf"),
        githubLink: "path/to/github/repo",
        images: [require("./MechanicalProjects/Gearbox/Gearbox.JPG")],
    ...
    {
        id: 16,
        title: "OEC - Helping Hand: An At-Home Full Care Overbed Table for Huntington’s Disease Patients",
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/oec/OnBedTable-AgamGurkiratUdaiBaldeep/HelpingHand Presentation.pdf"),
        githubLink: "path/to/github/repo",
        images: [require('./MechanicalProjects/oec/OnBedTable-AgamGurkiratUdaiBaldeep/HelpingHand Flyer.jpg'), require("./MechanicalProjects/oec/OnBedTable-AgamGurkiratUdaiBaldeep/Base Technical Drawing.jpg"), require("./MechanicalProjects/oec/OnBedTable-AgamGurkiratUdaiBaldeep/Frame Technical Drawing.jpg"), require("./MechanicalProjects/oec/OnBedTable-AgamGurkiratUdaiBaldeep/HelpingHand Technical Drawing.jpg"), require("./MechanicalProjects/oec/OnBedTable-AgamGurkiratUdaiBaldeep/Table Technical Drawing.jpg")],
    ...
    },
    {
        ...
        image: "path/to/image.jpg",
        pdfLink: require("./MechanicalProjects/oec/Engineering Consulting Proposal.pdf"),
        githubLink: "path/to/github/repo",
        images: [],
        locationDuration: "Okanagan Engineering Competition, University of British Columbia Okanagan",
